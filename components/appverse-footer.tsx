...
const defaultContent: FooterContent = {
  ...
  copyright: "© 2025 — Awan Keusahawanan International",
}
              ...
              <div className="relative rounded-[28px] liquid-glass p-2 shadow-2xl">
                <div className="relative aspect-[9/19] w-full overflow-hidden rounded-2xl bg-black">
                  ...
                  <LazyVideo
                    ...
                    muted={true}
                    playsInline={true}
                    aria-label="Awan Keusahawanan app preview - approvals made easy"
                  />
                  {/* On-screen content */}
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-1.5">
                <Image
                  ...
                  className="h-6 w-6"
                />
                <span className="text-xl font-semibold text-lime-300">Awan Keusahawanan</span>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-neutral-300">
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      href="https://twitter.com/awankeusahawanan"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Follow Awan Keusahawanan on Twitter"
                    >
                      X/Twitter
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      href="https://www.youtube.com/@awankeusahawanan"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Subscribe to Awan Keusahawanan on YouTube"
                    >
                      YouTube
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      href="https://instagram.com/awankeusahawanan"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Follow Awan Keusahawanan on Instagram"
                    >
                      Instagram
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      href="https://threads.com/awankeusahawanan"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Follow Awan Keusahawanan on Threads"
                    >
                      Threads
                    </a>
                  </li>
