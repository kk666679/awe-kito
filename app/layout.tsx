...
export const metadata: Metadata = {
  title: "Awan Keusahawanan | Comprehensive Cloud Platform for Malaysian SMEs",
  description:
    "Integrated business management tools (CRM, Inventory, Invoicing) with powerful cloud compute resources for AI, rendering, and data processing. Multi-tenant platform built for Malaysian businesses.",
  generator: "v0.app",
}
        ...
        <Script id="dynamic-favicon" strategy="beforeInteractive">
          {`
            function updateFavicon() {
              ...
              const faviconHref = darkMode ? '/icons/awan-keusahawanan-white.svg' : '/icons/favicon-dark.svg';
